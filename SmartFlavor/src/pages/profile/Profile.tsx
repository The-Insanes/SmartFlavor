        ...
        <IonPage>
            ...
            <IonContent className="djaskldjlsa" fullscreen>
                <div className="center-page-87y1923">
                    <ProfileContainer className="user-info" user_name={"Chef Ruperto"} post_num={23} follow_num={321} following_num={999} profile_photo={"images/profile_photos/chef 1.jpg"} description={"Estuvo dificil esto :c"} view_edit={true}/>
